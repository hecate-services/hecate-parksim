...
|----------|-------------|--------|
| [PLAN_DECENTRALIZED_NFR_DEMO.md](PLAN_DECENTRALIZED_NFR_DEMO.md) | Use parksim to demonstrate/motivate decentralized-vs-centralized event-store NFRs; Phase 1 = Decentralization Scorecard + partition/sovereignty/self-heal runbook, Phase 2 = charging-as-a-decentralized-process | 🟢 Phase 1 + 2 shipped |
