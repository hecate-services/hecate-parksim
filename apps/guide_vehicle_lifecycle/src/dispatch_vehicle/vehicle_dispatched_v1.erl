...
-export([get_vehicle_id/1, get_company_id/1, get_ride_id/1, get_trip_id/1,
         get_pickup_x/1, get_pickup_y/1,
...
to_map(#vehicle_dispatched_v1{} = E) ->
    #{event_type    => <<"vehicle_dispatched">>,
      ...
      plate    => E#vehicle_dispatched_v1.plate,
      company_id    => E#vehicle_dispatched_v1.company_id,
      ride_id       => E#vehicle_dispatched_v1.ride_id,
...
get_company_id(#vehicle_dispatched_v1{company_id = V})       -> V.
get_ride_id(#vehicle_dispatched_v1{ride_id = V})             -> V.
