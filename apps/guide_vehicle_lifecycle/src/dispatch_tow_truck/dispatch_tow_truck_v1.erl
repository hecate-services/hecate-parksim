...
-record(dispatch_tow_truck_v1, {vehicle_id, plate, company_id, tow_truck_id, dispatched_at}).
...
f(Id, M) -> #dispatch_tow_truck_v1{vehicle_id=Id, plate=maps:get(plate,M,undefined), company_id=maps:get(company_id,M,undefined), tow_truck_id=maps:get(tow_truck_id,M,undefined), dispatched_at=maps:get(dispatched_at,M,undefined)}.
fb(Id, M) -> #dispatch_tow_truck_v1{vehicle_id=Id, plate=maps:get(<<"plate">>,M,undefined), company_id=maps:get(<<"company_id">>,M,undefined), tow_truck_id=maps:get(<<"tow_truck_id">>,M,undefined), dispatched_at=maps:get(<<"dispatched_at">>,M,undefined)}.
validate(#dispatch_tow_truck_v1{vehicle_id=undefined}) -> {error, missing_aggregate_id};
validate(#dispatch_tow_truck_v1{}) -> ok.
to_map(#dispatch_tow_truck_v1{}=C) -> #{command_type=><<"dispatch_tow_truck">>, vehicle_id=>C#dispatch_tow_truck_v1.vehicle_id, plate=>C#dispatch_tow_truck_v1.plate, company_id=>C#dispatch_tow_truck_v1.company_id, tow_truck_id=>C#dispatch_tow_truck_v1.tow_truck_id, dispatched_at=>C#dispatch_tow_truck_v1.dispatched_at}.
