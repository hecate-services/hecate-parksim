...
-record(request_tow_v1, {vehicle_id, plate, company_id, x, y, requested_at}).
...
f(Id, M) -> #request_tow_v1{vehicle_id=Id, plate=maps:get(plate,M,undefined), company_id=maps:get(company_id,M,undefined), x=maps:get(x,M,undefined), y=maps:get(y,M,undefined), requested_at=maps:get(requested_at,M,undefined)}.
fb(Id, M) -> #request_tow_v1{vehicle_id=Id, plate=maps:get(<<"plate">>,M,undefined), company_id=maps:get(<<"company_id">>,M,undefined), x=maps:get(<<"x">>,M,undefined), y=maps:get(<<"y">>,M,undefined), requested_at=maps:get(<<"requested_at">>,M,undefined)}.
validate(#request_tow_v1{vehicle_id=undefined}) -> {error, missing_aggregate_id};
validate(#request_tow_v1{}) -> ok.
to_map(#request_tow_v1{}=C) -> #{command_type=><<"request_tow">>, vehicle_id=>C#request_tow_v1.vehicle_id, plate=>C#request_tow_v1.plate, company_id=>C#request_tow_v1.company_id, x=>C#request_tow_v1.x, y=>C#request_tow_v1.y, requested_at=>C#request_tow_v1.requested_at}.
